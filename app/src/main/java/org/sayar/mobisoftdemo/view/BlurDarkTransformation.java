...
public class BlurDarkTransformation extends BitmapTransformation {

    private WeakReference<Context> context;

    public BlurDarkTransformation(Context context) {
        super();
...
//            ColorFilter filter = new LightingColorFilter(0x90909090, 0x00000000);
            ColorFilter filter = new LightingColorFilter(0x59595959, 0x00000000);
